            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('product.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="qty" value="{{ $product->qty }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
                    <div class="mb-6">
